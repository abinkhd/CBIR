    ...
    <div class="container-fluid" >
               <div class="hedder-up row">
                  <div class="col-lg-3 col-md-3 logo-head">
                      <h1><a style="font-style: italic !important;" class="navbar-brand" href="admin_home.jsp"><b>Student Online</b></a></h1>
                  </div>
               </div>
            <nav class="navbar navbar-expand-lg navbar-light  ">
               ...
               <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                  <ul class="navbar-nav ">
                     ...
                     <li class="nav-item">
                        <a href="admin_settings_home.jsp" class="nav-link">Admin Settings   </a>
                     </li>
                     <li class="nav-item">
                        <a href="admin_login.jsp" class="nav-link">Log Out</a>
                     </li>  
                  </ul>
               </div>
            </nav>
