...
<!--                     <li class="nav-item active">
                     ...
                     <li class="nav-item">
                        <a href="search_category.jsp" class="nav-link">Category</a>
                     </li>
                     <li class="nav-item">
                        <a href="search_products.jsp" class="nav-link">Products</a>
                     </li>
                     <li class="nav-item">
                        <a href="search_seller.jsp" class="nav-link">Seller</a>
                     </li>
                     <li class="nav-item">
                        <a href="search_tags.jsp" class="nav-link">Tags</a>
                     </li>
                      <li class="nav-item">
                        <a href="customer_home.jsp" class="nav-link">Back</a>
                     </li>
                  </ul>
               </div>
            </nav>
